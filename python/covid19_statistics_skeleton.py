...
print('### Korean COVID-19 New Cases by Region (Per 1 Million People)')
print('* Total new cases:', sum_covid)
print()
print('| Region | New Cases | Ratio (%) | New Cases Per Million |')
print('| ------ | --------- | --------- | -------------------- |')
for idx, cases in enumerate(n_covid):
    ratio = (cases / sum_covid) * 100  # 해당 지역의 확진자 수 비율(%)
